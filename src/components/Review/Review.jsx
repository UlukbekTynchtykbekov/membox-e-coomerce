                                    ...
                                    <div className="swiper__review">
                                        ...
                                        <div className="info swiper__info">
                                            ...
                                            <div className="pro swiper__pro">
                                                ...
                                                <div className="swiper__text">Очень прикольный ящичек с мини-фомкой! Покупали
                                                    начальнику что-то необычное от коллектива. Надеемся, что
                                                    разнообразим впечатления человека, которого сложно удивить. Нашли
                                                    магазин в инстаграмме. Идея ящика прям зашла! Мы выбрали
                                                    предложенный комплект, но порадовало то, что можно собрать набор на
                                                    свое усмотрение.
                                                </div>
                                            </div>
                                            ...
                                            <div className="text swiper__texts">
                                                ...
                                                <div className="swiper__text">Очень порадовало то, что по просьбе перенесли
                                                    доставку на удобное для нас время. И менеджер вежливый и понимающий,
                                                    и курьер обязательный! Позвонил, узнал готовы ли мы принимать. Очень
                                                    приятно было со всеми общаться.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="swiper__slide">
                                    <div className="swiper__review">
                                        ...
                                        <div className="info swiper__info">
                                            ...
                                            <div className="pro swiper__pro">
                                                <div data-v-ace0e88e="">Достоинства:</div>
                                                <div data-v-ace0e88e="">Очень прикольный ящичек с мини-фомкой! Покупали
                                                    начальнику что-то необычное от коллектива. Надеемся, что
                                                    разнообразим впечатления человека, которого сложно удивить. Нашли
                                                    магазин в инстаграмме. Идея ящика прям зашла! Мы выбрали
                                                    предложенный комплект, но порадовало то, что можно собрать набор на
                                            ...
                                            <div className="contra">
                                                <div data-v-ace0e88e="">Недостатки:</div>
                                                <div data-v-ace0e88e="">Пока не заметили</div>
                                            </div>
                                            <div className="text">
                                                <div data-v-ace0e88e="">Коменнтарий:</div>
                                                <div data-v-ace0e88e="">Очень порадовало то, что по просьбе перенесли
                                                    доставку на удобное для нас время. И менеджер вежливый и понимающий,
                                                    и курьер обязательный! Позвонил, узнал готовы ли мы принимать. Очень
                                                    приятно было со всеми общаться.
                                                </div>
