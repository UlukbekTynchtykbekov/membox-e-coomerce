...
const ProductCard = ({setModalActive}) => {
    return (
        <>
            <div className="col-4 product__column">
                <div onClick={() => setModalActive(true)} className="product__item">
                    ...
                    <div className="product__button">
                        <button onClick={() => setModalActive(true)} className="product__btn product__search-btn">
            ...
            <div onClick={() => setModalActive(true)} className="col-4 product__column">
